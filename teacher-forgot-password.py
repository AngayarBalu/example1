...
def reset_teacher_password(email,name,regId):
    ...
    part2 = MIMEText(u'<a href="http://127.0.0.1:5487/teacher/forgot-password">Click here to reset your password</a>','html')
...
def update_teacher_password(email,regno,password,name):
    ...
    part2 = MIMEText(u'<a href="http://127.0.0.1:5487/teacher/login">Click here to login</a>','html')
    part3 = MIMEText('\n\nWarm Regards and thanks,\nJakstech Team,\nJakstech Solutions.','plain')
    message.attach(part1)
    message.attach(part2)
    message.attach(part3)
